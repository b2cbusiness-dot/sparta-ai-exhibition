...
const LeadGen: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 items-start">
      ...
      <div className="bg-indigo-600 text-white rounded-2xl p-8 md:p-10 shadow-lg relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-sm font-bold text-indigo-200 uppercase tracking-wider mb-2">스파르타 AI 교육</h2>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-indigo-100 text-sm">마우스를 잡는 법부터 차근차근, 눈높이에 맞춰 설명해드립니다.</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-indigo-100 text-sm">손주에게 줄 동화책, 추억이 담긴 그림 등 진짜 결과물을 만듭니다.</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-indigo-100 text-sm">비슷한 연령대의 동료들과 함께 즐겁게 배우고 소통하세요.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit" 
            className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-4 rounded-xl shadow-lg transition-colors flex items-center justify-center gap-2"
          >
            무료 상담 신청하기
          </button>
        </form>
